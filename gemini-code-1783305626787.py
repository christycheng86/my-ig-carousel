...
【啟動：IG 5頁輪播文自動生成器模組】
請嚴格按照以下「畫面與文字映射邏輯」輸出輪播文，確保每頁字數控制在 50 字內，方便直接複製進 Canva 或自動排版工具：

- [P1 封面：痛點懸念] 
  * 畫面視覺：黑底白字，核心痛點字體放大 200%，使用強烈對比色。
  * 標題文案：(根據隨機核心痛點生成最具衝擊力的香港廣東話標題)

- [P2 現狀：精準撕裂] 
  * 畫面視覺：白底黑字，用紅圈或底線標記出受眾的內耗行為。
  * 核心文案：(直擊受眾心大心細、死守碎銀、怕輸籌碼的內耗現狀)

- [P3 轉折：底層代碼] 
  * 畫面視覺：加入幾何圖形或能量表視覺，營造專業玄學/心理學感。
  * 核心文案：(一針見血引入個人週期表或天賦密碼的能量反轉解釋)

- [P4 解法：商業實踐] 
  * 畫面視覺：清晰的 Step-by-Step 箭頭流程圖。
  * 核心文案：(給出明確的出路：收斂無謂試錯、落戶輕資產變現通道、釐清防禦防線)

- [P5 結尾：高價值收藏 CTA] 
  * 畫面視覺：主視覺字體加粗，右下角有明顯的「儲存」與「私訊」手勢圖標。
  * 互動文案：【立刻儲存，別再倒錢落海】！私訊我「[關鍵字]」，親自幫你拆解你的人生說明書！
...
4. 語言風格：【地道香港廣東話（結合少量專業術語）】，用最入骨、最生活化的廣東話直擊痛點，讓人一睇就明、感同身受。
...
（結構：0-3秒黃金吸睛鉤子 ➔ 痛點共鳴 ➔ 一針見血的玄學核心反轉 ➔ 行動引導。必須包含畫面視覺提示與口白）
- 腳本 1：【反常識/反直覺流】
- 腳本 2：【標籤定義與數字震撼流】
- 腳本 3：【苦難翻盤與極致對比流】
- 腳本 4：【低認知負載清單流】
...
（結構：條列化、標題清楚。請詳細寫出第 1 頁到第 5 頁的精準文字，每頁字數適中，第 5 頁為高價值收藏型 CTA）
- 輪播文 1：【反常識顛覆認知】
- 輪播文 2：【數字震撼/標籤對座】
- 輪播文 3：【結果先行+少走彎路】
- 輪播文 4：【特定群體精準避坑】
...
---
請直接開始輸出，保持【直接、細膩、銳利、地道廣東話】的語氣，標題清楚，條列化。"""
